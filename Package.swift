...
let package = Package(
    ...
    products: [
        ...
        .executable(name: "composer-runtime-helper", targets: ["ComposerRuntimeHelper"]),
        ...
        .library(name: "SymphonySync", targets: ["SymphonySync"]),
    ...
    targets: [
        ...
        .testTarget(
            name: "SymphonySyncTests",
            dependencies: ["SymphonyCore", "SymphonyInterfaces", "SymphonySync"]
        ),
        .testTarget(
        ...
        .testTarget(
            ...
            dependencies: ["SymphonyCore", "SymphonyLinearTracker"]
        ),
        .testTarget(
